...
$sql ="select count(*) as totaldriveruser
FROM tbluserdrivers";
$query= $dbh -> prepare($sql);
$query-> execute();
$results = $query -> fetchAll(PDO::FETCH_OBJ);
...
foreach($results as $result)
{
 $totaldriveruser=$result->totaldriveruser;   
...
<head>
    ...
    <title>DSHS | Admin Dashboard</title>
            ...
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                       Total Registered Drivers </div>
                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $totaldriveruser; ?></div>
                </div>
